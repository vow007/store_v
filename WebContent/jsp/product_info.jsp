	...
	<div class="container">
		<div class="row">
				...
				<form id="myForm" method="post"
					...
					<div class="col-md-6">
						...
						<div style="margin: 10px 0 10px 0;">
							优惠价: <strong style="color: #ef0101;">￥：${product.shop_price}元</strong>
							市场价：
						...
						<div
							style="padding: 10px; border: 1px solid #e7dbb1; width: 330px; margin: 15px 0 10px 0; background-color:#DDDDDD;">
							...
							<div style="margin: 20px 0 10px 0;; ">
								<%--加入到购物车 --%>
								<!-- 取消链接的默认行为 -->
								<a href="javascript:void(0)"> <input id="btnId" value="加入购物车" type="button">
			...
			<div style="width: 950px; margin: 0 auto;">
				<div
					style="background-color:#99FFFF; width: 930px; padding: 10px 10px; margin: 10px 0 10px 0;">
					<strong>商品介绍</strong>
					<h3>${product.pdesc}</h3>
				</div>
			</div>
