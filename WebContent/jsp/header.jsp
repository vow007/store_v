			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse"
					...
					<!--form class="navbar-form navbar-right" role="search" 
							  action="${pageContext.request.contextPath}/ProductServlet?method=findProductsByPnameWithPage" method="post">
								<div class="form-group">
									<input type="text" class="form-control" placeholder="待搜索商品名"  name="goods"  id="goods">
								</div>
